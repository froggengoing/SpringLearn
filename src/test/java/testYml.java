...
/*        JsonParser parser = JsonParserFactory.getJsonParser();
        Map<String, Object> stringObjectMap = parser.parseMap("{\"foo\":\"bar\"}");
        stringObjectMap.forEach((k,v)-> System.out.println(k+"="+v));*/
        ClassRelativeResourceLoader classRelativeResourceLoader = new ClassRelativeResourceLoader(testYml.class);
        Resource resource = classRelativeResourceLoader.getResource("classpath:/application-hello.yml");
        ...
        /*resourceLoader.getResource("classpath:/application-hello.yml")*/
    }
    ...
    private static class Document {
        ...
        Document(PropertySource<?> propertySource, String[] profiles,
                 Set<String> activeProfiles, Set<String> includeProfiles) {
